...
def get_data():
    ...
    url = "https://roscarservis.ru/catalog/legkovye/?arCatalogFilter_458_1500340406=Y&set_" \
          "filter=Y&sort%5Brecommendations%5D=asc&limit=16&PAGEN_1=1"
    ...
    for page in range(1, pages_count + 1):
        ...
        url = f"https://roscarservis.ru/catalog/legkovye/?arCatalogFilter_458_1500340406=Y&set_" \
              f"filter=Y&sort%5Brecommendations%5D=asc&limit=16&PAGEN_1={page}"
